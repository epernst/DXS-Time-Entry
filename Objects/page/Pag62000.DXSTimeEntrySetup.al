page 62000 "DXS TimeEntrySetup"
{
    Caption = 'DXS Time Entry Setup';
    PageType = Card;
    SourceTable = "DXS TimeEntrySetup";
    DeleteAllowed = false;
    InsertAllowed = false;
    UsageCategory = Administration;
    AccessByPermission = tabledata "DXS TimeEntrySetup" = rmi;
    ...
    actions
    {
        area(Navigation)
        {
            action("DXS UpgradeNAV2017")
            {
                ...
                trigger OnAction();
                var 
                    TimeMigration : Codeunit "DXS TimeDataMigration";
                begin
            ...
            action("DXS HelpResources")
            {
                ...
                RunObject = page "DXS TimeHelpResources";
