codeunit 62012 "DXS TimeNotificationHandler"
{
    trigger OnRun();
    begin
    end;
    ...
    var
        TimePermissionHandler : Codeunit "DXS TimePermissionHandler";
    begin
    ...
    begin
        ...
        with TimeNotification do begin
            ...
            AddAction(NoSetupNotificationAct,Codeunit::"DXS TimeNotificationHandler",'RunAssistedSetup');
            AddAction(DismissFurtherNotificationsAct,Codeunit::"DXS TimeNotificationHandler",'DismissNotification');
            Send();
        end;
    end;
    ...
    begin
        ...
        with TimeNotification do begin
            ...
            Scope := NotificationScope::LocalScope;
            AddAction(NoHourUnitOfMeasureSetupAct,Codeunit::"DXS TimeNotificationHandler",'RunSetupHourUnitOfMeasure');
            AddAction(DismissFurtherNotificationsAct,Codeunit::"DXS TimeNotificationHandler",'DismissNotification');
            Send();
        end;
    end;
    ...
    var
        TimeEntrySetupWizard : Page "DXS TimeEntrySetupWizard";
    begin
