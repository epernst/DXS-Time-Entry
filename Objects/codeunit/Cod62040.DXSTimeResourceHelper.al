codeunit 62040 "DXS TimeResourceHelper"
{
    trigger OnRun();
    begin
        InitializeResources();
    ...
    var
        HelpResource: Record "DXS TimeHelpResource";
    begin
    ...
    var
        ...
        DxTimeIcon: Codeunit "DXS TimeIcon70x70";
    begin
    ...
    var
        ...
        DxTimeIcon: Codeunit "DXS TimeIcon150x150";
    begin
        DxTimeIcon.GetIcon(TempBlob);
    ...
    var
        ...
        DxTimeIcon: Codeunit "DXS TimeIcon250x250";
    begin
        DxTimeIcon.GetIcon(TempBlob);
    ...
    var
        ...
        DxTimeIcon: Codeunit "DXS TimeIcon417x417";
    begin
        DxTimeIcon.GetIcon(TempBlob);
    ...
    var
        DxTimeHelpResource: Record "DXS TimeHelpResource";
    begin
