page 62001 "DXS.Time Entry Setup Wizard"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group(UnitOfMeasureStep)
            {
                ...
                part(UnitOfMeasurePart; "DXS.Unit Of Measure Part")
                {
                    ApplicationArea = All;
                    Caption = '';
                }
    ...
    var
        ...
        AssistedSetup: Codeunit "DXS.Time Assisted Setup";
    begin
