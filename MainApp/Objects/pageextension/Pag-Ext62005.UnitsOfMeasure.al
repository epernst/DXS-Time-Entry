pageextension 62005 "DXS.Units Of Measure" extends "Units of Measure"
{
    layout
    {
    ...
    actions
    {
        addlast(Navigation)
        {
            ...
            {
                Caption = 'DXS Time';
                action("DXS.DXS DxTimeEntrySetup")
                {
                    AccessByPermission = TableData "DXS.Time Entry Setup" = R;
                    ApplicationArea = All;
                    Caption = 'Time Entry Setup';
                    Image = Setup;
                    RunPageMode = Edit;
                    RunObject = Page "DXS.Time Entry Setup";
